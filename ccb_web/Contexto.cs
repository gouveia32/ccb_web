    ...
    public class Contexto : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
           ...
           //modelBuilder.Entity<Matricula>().HasOptional(x => x.Turma);
            ...
            //Dados Cliente
            modelBuilder.Entity<Cliente>().Property(x => x.Nome).HasColumnType("varchar").HasMaxLength(120);
            modelBuilder.Entity<Cliente>().Property(x => x.Contato_Funcao).HasColumnType("varchar").HasMaxLength(20);
            modelBuilder.Entity<Cliente>().Property(x => x.Contato_Nome).HasColumnType("varchar").HasMaxLength(40);
            modelBuilder.Entity<Cliente>().Property(x => x.Cgc_Cpf).HasColumnType("varchar").HasMaxLength(18);
            modelBuilder.Entity<Cliente>().Property(x => x.Inscr_Estadual).HasColumnType("varchar").HasMaxLength(20);
            modelBuilder.Entity<Cliente>().Property(x => x.Endereco).HasColumnType("varchar").HasMaxLength(100);
            modelBuilder.Entity<Cliente>().Property(x => x.Cidade).HasColumnType("varchar").HasMaxLength(40);
            modelBuilder.Entity<Cliente>().Property(x => x.Estado).HasColumnType("varchar").HasMaxLength(2);
            modelBuilder.Entity<Cliente>().Property(x => x.Cep).HasColumnType("varchar").HasMaxLength(9);
            modelBuilder.Entity<Cliente>().Property(x => x.Telefone1).HasColumnType("varchar").HasMaxLength(20);
            modelBuilder.Entity<Cliente>().Property(x => x.Telefone2).HasColumnType("varchar").HasMaxLength(20);
            modelBuilder.Entity<Cliente>().Property(x => x.Telefone3).HasColumnType("varchar").HasMaxLength(20);
            modelBuilder.Entity<Cliente>().Property(x => x.Email).HasColumnType("varchar").HasMaxLength(60);
            modelBuilder.Entity<Cliente>().Property(x => x.Obs).HasColumnType("varchar").HasMaxLength(1024);
            modelBuilder.Entity<Cliente>().Property(x => x.Preco_Base).HasColumnType("decimal").HasPrecision(6, 2);
        }
